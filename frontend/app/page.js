    ...
    <div className='home'>
      <div className='home_inner'>
        <h1 className='home_inner_title'>
          ...
          <span className='home_inner_title_colored'>
            listes de souhaits
          </span>{" "}
          et{" "}
          <span className='home_inner_title_colored'>
            réaliser les souhaits
          </span>{" "}
          de vos amis et de votre famille.
        </h1>
        <p className='home_inner_description'>
          WishBlock te permet d'enregistrer, partager et suivre les
          souhaits de tes proches sur la blockchain pour une
          expérience transparente et sécurisée.
        </p>
